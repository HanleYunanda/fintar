...
public class LoanController {
    ...
    public ResponseEntity<ApiResponse<LoanStatusHistoryResponse>> reviewApplication(
            @RequestBody @Valid ChangeLoanStatusRequest req,
    ...
    public ResponseEntity<ApiResponse<LoanStatusHistoryResponse>> approveRejectApplication(
        ...
        LoanStatus approvalStatus = req.getAction() == LoanStatus.APPROVED ? LoanStatus.APPROVED : LoanStatus.REJECTED;
        return ResponseUtil.ok(isApproved, "Successfully " + approvalStatus.toString() + " loan application");
    }
